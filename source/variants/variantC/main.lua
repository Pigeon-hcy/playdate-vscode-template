...
import "variants/variantC/workstationManager"
import "variants/variantC/grinderWorkstation"
import "variants/variantC/fryingWorkstation"
import "variants/variantC/fryingWarning"
import "variants/variantC/supplyWarning"
import "variants/variantC/assemblyWorkstation"
import "variants/variantC/orderUI"
import "variants/variantC/rushBanner"
import "variants/variantC/scorePopup"
import "variants/variantC/helpCard"
import "gameVersions"
import "titleScreen"
...
function playdate.update()
    ...
    if RushBanner.isActive() or HelpCard.isOpen() then
        ...
        if WorkstationManager.isSwitching() then
            -- Discard hidden crank movement so it cannot fill a QTE or grind
            -- meat when the transition finishes.
            pd.getCrankTicks(PlayerConfig.assembly.crankTicksPerTurn)
            pd.getCrankChange()
        end
