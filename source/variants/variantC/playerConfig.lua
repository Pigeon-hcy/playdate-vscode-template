import "variants/variantC/recipes"
...
PlayerConfig = {
    ...
    assembly = {
        ...
        -- Variant C builds the displayed recipe in order. Each step has one
        -- fixed quick-time action, so there is no ingredient picker.
        qte = {
            comboWindow = 0.65,
            crankDegrees = 60,
            ingredients = {
                P = { tokens = { "CRANK" }, label = "🎣 SHAKE" },
                L = { tokens = { "A" }, label = "Ⓐ" },
                T = { tokens = { "DOWN" }, label = "⬇" },
                K = { tokens = { "B" }, label = "Ⓑ" },
                O = { tokens = { "A", "DOWN" }, label = "Ⓐ + ⬇" },
                E = { tokens = { "B", "DOWN" }, label = "Ⓑ + ⬇" },
                M = { tokens = { "CRANK", "DOWN" }, label = "🎣 + ⬇" },
                B = { tokens = { "CRANK", "A" }, label = "🎣 + Ⓐ" },
                A = { tokens = { "CRANK", "B" }, label = "🎣 + Ⓑ" },
                S = { tokens = { "A", "B" }, label = "Ⓐ + Ⓑ" },
            },
            topBun = { tokens = { "UP", "A" }, label = "⬆ + Ⓐ" },
            serve = { tokens = { "UP", "B" }, label = "⬆ + Ⓑ" },
        },
        ingredientSprites = {
            P = "Patty",
            O = "Onion",
