import "variants/variantB/recipes"
...
PlayerConfig = {
    ...
    frying = {
        slotCount = 8,
        flameFramesPerSecond = 12,
        oilFramesPerSecond = 10,
        fire = {
            minPresses = 3,
            maxPresses = 6,
            startShakeDuration = 0.4,
            startShakeAmplitude = 3,
            pressShakeDuration = 0.22,
            pressShakeAmplitude = 5,
            dialogCenterX = 200,
            dialogCenterY = 128,
        },
        warning = {
    ...
    assembly = {
        ...
        ingredientCards = {
            ...
            initialsHeight = 24,
            abbreviations = {
                P = "P", A = "A", T = "T", L = "L", K = "PK",
            },
            names = {
                P = "PATTY", A = "AMERICAN CHEESE", T = "TOMATO",
                L = "LETTUCE", K = "PICKLE",
            },
            -- The shared card sheet still contains all ten original items.
            -- These source positions let this version show only its five.
            sourceIndices = {
                P = 1, A = 9, T = 3, L = 4, K = 5,
            },
        },
        ...
        spriteNaturalOverhang = { A = true, L = true },
        spriteMaxHeights = {
            P = 60, A = 64, T = 50, L = 66, K = 40,
        },
        ...
        spriteBaselines = {
            -- A/L retain their original seats (4/6), plus 10px to offset
            -- the raised bun support plane and keep the intentional drape.
            P = 6, A = 14, T = 1, L = 16, K = 1,
        },
        breadBaselines = {
            bottom = 0,
            top = 0,
